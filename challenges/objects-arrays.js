...
const uni = [];
// console.log(uni);
let students = graduates.filter((univ) => univ.university.indexOf('Uni') > -1);
uni.push(students);
console.log(`${students.length} Universities has the term Uni included in their names`);
console.log(uni);
